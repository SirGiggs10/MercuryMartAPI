...
namespace MercuryMartAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string[] origins = new string[] { "http://localhost:3000", "http://test.html:1", "https://mercury-mart.dr-drake.vercel.app", "https://mercury-mart.vercel.app", "https://mercury-mart-git-main.dr-drake.vercel.app", "http://localhost:4200", "http://localhost:4300", "http://localhost:4400",
