...
namespace MercuryMartAPI.Interfaces
{
    public interface IRoleManagementRepository
    {
        ...
        public Task<ReturnResponse> DeleteRoles(List<int> rolesIds);
        ...
        public Task<ReturnResponse> DeleteProjectModule(List<int> projectModulesIds);
        ...
        public Task<ReturnResponse> DeleteFunctionality(List<int> functionalitiesIds);
        public Task<ReturnResponse> AssignFunctionalitiesToRole(FunctionalityRoleAssignmentRequest functionalityRoleAssignmentRequest);
    }
}
